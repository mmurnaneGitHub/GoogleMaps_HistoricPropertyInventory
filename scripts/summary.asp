...
<%
  ...
  Response.Write "</td></tr><tr><td>"
	...
	'Links & Map
	 ...
	 'googleMap    'don't use anymore since Google started 6/11/2018 requires: enable billing on each of your projects using Maps Static API - https://developers.google.com/maps/documentation/maps-static/usage-and-billing 
...
Sub googleMap
    'Details - https://developers.google.com/maps/documentation/maps-static/intro
    Response.Write "<div align=center>"
    Response.Write "<img src='https://maps.googleapis.com/maps/api/staticmap?center="
    Response.Write iMap
    Response.Write "&zoom=18&size=450x450"
    Response.Write "&maptype=roadmap"
    'Response.Write "&markers=color:blue%7C"
    'Response.Write iMap
    Response.Write "&key=AIzaSyAPoaOE5Rhl1zF-w8kXaJ0taaDSvdi1L44"
