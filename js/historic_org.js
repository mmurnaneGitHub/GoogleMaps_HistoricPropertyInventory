...
function init() {
 ...
 var mapOptions = {
  ...
  var dynamap = new gmaps.ags.MapOverlay(url, { opacity: 0.75 });
      //Only works with Google Maps v3.31 and below - https://github.com/googlemaps/v3-utility-library/issues/397
      //New possibility - https://github.com/googlemaps/v3-utility-library/tree/master/arcgislink
      dynamap.setMap(map); //add dynamic layer to map - ERROR: Uncaught TypeError: Cannot read property 'parentNode' of null  at _126.onRemove (arcgislink.js:1)
