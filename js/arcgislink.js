 ...
 * @property {Array.OverlayView|Array.object} [geometries] Array of <code>google.maps.LatLng, Polyline, Polygon</code>, or ESRI Geometry format to project.
  ...
  */
  ...
  /* FIX 8/16/2018 - https://github.com/googlemaps/v3-utility-library/issues/432 - R2018/R406
  ...
  */
  MapOverlay.prototype.draw = function () { if (!this.drawing_ || this.needsNewRefresh_ === true) { if (this.overlay_==null) { this.refresh(); } } };  //FIX 8/16/2018 - https://github.com/googlemaps/v3-utility-library/issues/432
  console.error('FIX 8/16/2018 (pogione commented on Aug 15) - https://github.com/googlemaps/v3-utility-library/issues/432');
  ...
  MapOverlay.prototype.refresh = function () {
    ...
    this.mapService_.exportMap(params, function (json) {
      ...
      if (json.imageData) {
       //MJM - fix for base64 images
       json.href = 'data:image/png;base64,' + json.imageData;
      }
