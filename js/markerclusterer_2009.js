...
function MarkerClusterer(map, opt_markers, opt_opts) {
  ...
  var i = 0;
  //MarkerClusterer.prototype.MARKER_CLUSTER_IMAGE_PATH_ = '../HistoricMap/images/m';
  //original: 'url': "http://gmaps-utility-library.googlecode.com/svn/trunk/markerclusterer/images/m" + i + ".png",

  for (i = 1; i <= 5; ++i) {
    styles_.push({
      'url': "../HistoricMap/images/m" + i + ".png",
      'height': sizes[i - 1],
      'width': sizes[i - 1]
    });
  }
